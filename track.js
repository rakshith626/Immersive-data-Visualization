var _gauges=_gauges||[];
(function(){var h=(_gauges['slice'])?_gauges.slice(0):[];
_gauges={track_referrer:true,image:new Image(),track:function(){this.setCookie('_gauges_cookie',1,1);
var a=this.url();
if(a){this.image.src=a;
var b=60*60,d=b*24,c=d*31,f=d*365,i=f*10;
...
},push:function(a){var b=a.shift();if(b=='track')
{_gauges.track()}},url:function(){var a,b,d,c=this.$('gauges-tracker');
if(c){b=c.getAttribute('data-site-id');d=c.getAttribute('data-track-path');
if(!d){d=c.src.replace('/track.js','/track.gif')
}a=String(d);a+="?h[site_id]="+b;a+="&h[resource]="+this.resource();a+="&h[referrer]="+this.referrer();
